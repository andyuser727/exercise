  ...
  private void cellTableStyleInitializer() {
    cellTableStyle = new com.google.gwt.user.cellview.client.CellTable.Style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GMOK10PCED{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GMOK10PCFD{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GMOK10PCOC{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GMOK10PCDE{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GMOK10PCDE:hover{color:" + ("#6c6b6b")  + ";}.GMOK10PCPC{background:" + ("#fff")  + ";}.GMOK10PCAD{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GMOK10PCPD{background:" + ("#f3f7fb")  + ";}.GMOK10PCAE{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GMOK10PCGD{background:" + ("#eee")  + ";}.GMOK10PCHD{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GMOK10PCJD{background:" + ("#ffc")  + ";}.GMOK10PCKD{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GMOK10PCBE{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GMOK10PCCE{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GMOK10PCID{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GMOK10PCOD{margin:") + (("30px")  + ";}")) : ((".GMOK10PCED{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GMOK10PCFD{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GMOK10PCOC{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GMOK10PCDE{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GMOK10PCDE:hover{color:" + ("#6c6b6b")  + ";}.GMOK10PCPC{background:" + ("#fff")  + ";}.GMOK10PCAD{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GMOK10PCPD{background:" + ("#f3f7fb")  + ";}.GMOK10PCAE{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GMOK10PCGD{background:" + ("#eee")  + ";}.GMOK10PCHD{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GMOK10PCJD{background:" + ("#ffc")  + ";}.GMOK10PCKD{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GMOK10PCBE{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GMOK10PCCE{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GMOK10PCID{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GMOK10PCOD{margin:") + (("30px")  + ";}"));
      }
